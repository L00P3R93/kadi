<meta name="game-token" content="{{ htmlspecialchars($googleId) }}">
<script>
const token = document.querySelector('meta[name="game-token"]').content;
window.GAME_AUTH = { token: token };
...
<link id='-gd-engine-icon' rel='icon' type='image/png' href='/kadig/index.icon.png' />
<link rel='apple-touch-icon' href='/kadig/index.apple-touch-icon.png'/>
<link rel='manifest' href='/kadig/index.manifest.json'>
...
<div id="fullscreenPrompt" class="hidden">
  <div class="prompt-content">
	...
	<script type='text/javascript' src='/kadig/index.js'></script>


<script>
if ('serviceWorker' in navigator) {
    fetch('/kadig/version.php')
    .then(r => r.text())
    .then(version => {
        version = version.trim();

        navigator.serviceWorker.register('/kadig/index.service.worker.js?v=' + encodeURIComponent(version), { scope: '/kadig/' })
        .then(reg => {
            if (reg.waiting) {
