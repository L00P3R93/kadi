    ...
    <div class="border-t border-[#222] bg-[#0f0f0f]" x-data>
        ...
        <template x-if="$store.betSlip.count() > 0">
            <div class="px-4 pt-4 pb-4 space-y-4">
                ...
                <div class="bg-[#1a1200] border border-[#f5c542]/20 rounded-lg p-3 text-center">
                    <div class="text-[#f5c542] text-xs font-bold mb-1">Sign in to place bets</div>
                    <div class="text-gray-600 text-[11px] mb-3">Create a free account to start winning</div>
                    <div class="flex gap-2">
                        <a href="{{ route('login') }}"
                           class="flex-1 text-center border border-[#f5c542] text-[#f5c542] font-bold py-2 rounded
                                  hover:bg-[#f5c542] hover:text-black transition text-xs">
                            Sign In
                        </a>
                        <a href="{{ route('register') }}"
                           class="flex-1 text-center bg-[#f5c542] text-black font-bold py-2 rounded
                                  hover:bg-[#ffde74] transition text-xs">
                            Register
                        </a>
                    </div>
                </div>
