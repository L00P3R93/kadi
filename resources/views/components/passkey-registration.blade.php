...
<div
    x-data="{
        ...
        init() {
            ...
            // Re-check after SDK late-load and after every SPA navigation,
            // since this component can appear mid-session via Livewire morphs.
            window.addEventListener('passkeys:ready', () => this.updateSupport(), { once: true });
            window.addEventListener('livewire:navigated', () => this.updateSupport());
        },
        async register() {
...
>
    ...
    <template x-if="supported && showForm">
        <div class="space-y-4 rounded-lg border border-yellow-800/30 bg-[#111111] p-4">
            <flux:input
