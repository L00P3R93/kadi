...
return [
    ...
    */
    ...
    'include_files' => [
        // Only the application's own logs (relative to storage/logs). The package's defaults also list
        // system paths such as /var/log/nginx: production should not expose those in a web page.
        '*.log',
        '**/*.log',
    ],
    /*
    ...
    */
    ...
    'exclude_files' => [
        // Written by Laravel Boost's browser-logs dev tool, not by the app. Never useful in the viewer.
        'browser.log',
    ],
