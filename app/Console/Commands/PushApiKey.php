...
#[Signature('push-api:key {--broadcast : Generate a key for system-wide broadcasts (PUSH_API_BROADCAST_KEY_HASHES) instead of per-player pushes}')]
...
class PushApiKey extends Command
{
    public function handle(): int
    {
        ...
        $variable = $this->option('broadcast') ? 'PUSH_API_BROADCAST_KEY_HASHES' : 'PUSH_API_KEY_HASHES';
